	...
	//g++ -Wall -g -Werror -std=c++11  <filename.cpp>   -o  <filename>//
...

	{
		...
		double Amp,g,Length; //Parameters for the system
	
		g=9.8;	Length=1.0;Amp=0.10;

	

		dy[0]  = yy[1];/*------Equations to be integrated-----*/
	...
	Time_Step_Size=0.001*(2*pi/Omega);
	...
	double y_Initial[2]={0.001,0.01};


	ofstream Write_To_File("Timeseries_below.dat");
