...
repl  (-1.0*cos(x)+cos(2*x)) w l lt 1 linewidth 4 lc rgb "black" ti "P=1.0"
#repl  (-2.0*cos(x)+cos(2*x)) w l lt 1 linewidth 2 lc rgb "magenta" ti "P=2.0"
repl  (-4.0*cos(x)+cos(2*x)) w l lt 1 linewidth 2 lc rgb "purple" ti "P=4.0"
set output 'potential-vs-thetapitopi.eps'
repl  (-8.0*cos(x)+cos(2*x)) w l  lt 1 linewidth 2 lc rgb "blue" ti "P=8.0"
